...
# Keys for gGA
R_MATRIX_KEY: Final[str] = "r_matrix"
REDUCED_DENSITY_MATRIX_KEY: Final[str] = "reduced_density_matrix"
VARIATIONAL_DENSITY_KEY: Final[str] = "variational_density"
INTERACTION_ENERGY_KEY: Final[str] = "interaction_energy"

ALL_ENERGY_KEYS: Final[List[str]] = [
    EDGE_ENERGY_KEY,
    PER_ATOM_ENERGY_KEY,
    TOTAL_ENERGY_KEY,
    INTERACTION_ENERGY_KEY,
    FORCE_KEY,
    PARTIAL_FORCE_KEY,
    STRESS_KEY,
    VIRIAL_KEY,
